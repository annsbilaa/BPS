...
public class  kemiskinanRVActivity_admin extends AppCompatActivity
{
    SwipeRefreshLayout swipeRefreshLayout;
    RecyclerView recyclerView;
    kemiskinanAdapter_admin adapter;
    DAOkemiskinan dao;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_rvkemiskinan);
        ...
        adapter= new kemiskinanAdapter_admin(this);
