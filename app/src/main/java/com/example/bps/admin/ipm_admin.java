...
public class ipm_admin extends AppCompatActivity
{
    ActionBar actionBar;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            Intent intent =new Intent(ipm_admin.this, ipmRVActivity_admin.class);
            startActivity(intent);
        });
        DAOipm dao =new DAOipm();
        dataipm emp_edit = (dataipm)getIntent().getSerializableExtra("EDIT");
        if(emp_edit !=null)
        {
            btn.setText("UPDATE");
        ...
        {
            dataipm emp = new dataipm(edit_name.getText().toString(), edit_position.getText().toString());
            if(emp_edit==null)
            {
