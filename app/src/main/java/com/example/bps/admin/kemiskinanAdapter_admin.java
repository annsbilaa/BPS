...
public class kemiskinanAdapter_admin extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    private Context context;
    ArrayList<datakemiskinan> list = new ArrayList<>();
    public kemiskinanAdapter_admin(Context ctx)
    {
        this.context = ctx;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position, datakemiskinan e)
    {
        ...
        vh.txt_option.setOnClickListener(v->
        {
            ...
            popupMenu.setOnMenuItemClickListener(item->
            {
                ...
                {
                    case R.id.menu_edit:
                        Intent intent=new Intent(context, kemiskinan_admin.class);
